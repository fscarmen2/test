...
T[C1]="全网首发: macOS 一键脚本，可视为免费、快速的基于 WireGuard 协议的 VPN"
...
install(){
	...
	curl -m8 -o /usr/local/bin/wgcf https://github.com/ViRb3/wgcf/releases/download/v"$latest"/wgcf_"$latest"_darwin_amd64 ||
